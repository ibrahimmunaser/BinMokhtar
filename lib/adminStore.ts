...
export function addProduct(productData: any): Product {
  ...
  const newProduct: Product = {
    ...
    price: Math.round(parseFloat(productData.price) * 100), // Convert to cents
    compareAtPrice: productData.compareAtPrice ? Math.round(parseFloat(productData.compareAtPrice) * 100) : undefined,
    ...
    descriptionHtml: productData.description ? `<p>${productData.description}</p>` : undefined,
