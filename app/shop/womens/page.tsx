...
const CATEGORIES = ['Abayas', 'Hijabs', 'Dresses', 'Accessories'];
...
export default function WomensCollectionPage() {
  ...
  const clearAllFilters = () => {
    router.push('/shop/womens', { scroll: false });
  };
  ...
  return (
    <>
      {/* Hero Banner */}
      <section className="relative h-[40vh] min-h-[300px] max-h-[500px] bg-surface-3 mt-8">
        <div className="absolute inset-0">
          <Image
            src="/images/Womens Page Header 2.png"
        ...
        <Container className="relative h-full flex items-center justify-center">
          <div className="text-center text-white">
            <h1 className="font-display text-4xl lg:text-6xl mb-3">WOMEN'S COLLECTIONS</h1>
            <p className="text-lg lg:text-xl text-white/90">Discover our premium range of elegant and modest attire</p>
          </div>
        </Container>
      </section>
