            ...
            {fulfillmentMethod === 'delivery' ? (
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-bmr-muted">
                    Send us a DM on Instagram or email info@binmukhtarretail.com to arrange your pickup time and location in the Detroit Metro Area.
                  </p>
                </div>
              </div>
            )}
            ...
            <div className="flex items-start gap-4 mb-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-bmr-muted mb-4">
                  To arrange pickup for your order, please send us a direct message on Instagram or email us at info@binmukhtarretail.com with your order reference.
                </p>
                <div className="flex flex-wrap gap-3">
                  ...
                  <a
                    href="mailto:info@binmukhtarretail.com?subject=Pickup%20Request"
                    className="inline-flex items-center gap-2 px-6 py-3 bg-bmr-ink text-white font-medium rounded-lg hover:bg-bmr-fg transition-all shadow-md hover:shadow-lg"
                  >
