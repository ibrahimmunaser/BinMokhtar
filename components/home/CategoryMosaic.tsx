          ...
          {tiles.map((tile, index) => {
            ...
            return (
              ...
              >
                ...
                {/* Content */}
                <div className="absolute inset-0 flex items-end justify-center text-center px-6 pb-2">
                  <div className="w-full">
                    <h3 className="font-display text-2xl md:text-3xl lg:text-5xl font-medium text-white mb-2">
                      {title}
                    </h3>
